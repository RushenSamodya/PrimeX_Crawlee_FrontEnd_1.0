...
function AboutUs () {
    return (
        <div>
                ...
                <br></br><br></br>
                    <SpanContainer>
                        <TextBox>
                            <Text>Why Us</Text>
                            <br></br>
                            <Para>I see this opportunity as a way to contribute to an exciting/forward-thinking/fast-moving company/industry, and I feel I can do so by/with my …” “I feel my skills are particularly well-suited to this position because "</Para>
                        </TextBox>
            ...
            <Container04>
            <Top>Our Mission</Top>
            <h1 className="course">Build Better For Best Economy</h1>
            <SpanContainer >
